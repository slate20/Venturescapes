...
@onready var business_name_label = $BusinessInfo/BusinessName
@onready var business_industry_label = $BusinessInfo/BusinessIndustry
...
func update_business_info():
	if GameManager.get_active_business():
		business_name_label.text = GameManager.get_active_business().business_name
		business_industry_label.text = GameManager.get_active_business().industry
	else:
		business_name_label.text = "Unknown"
		business_industry_label.text = "Unknown"
